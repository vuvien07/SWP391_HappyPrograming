...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="home"><span>Happy</span>Programing</a>
...
<!--                                                <li class="price">$199</li>-->
                        ...
                        <myTag:myPagination currentPage="${requestScope.page}" subject="list_mentor?" totalPages="${requestScope.num}"></myTag:myPagination>
