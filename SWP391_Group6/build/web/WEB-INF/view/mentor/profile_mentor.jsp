...
<html>
    ...
    <body>
        ...
        <div class="container-xl" style="margin-bottom: 10%">
            <form action="mentor_profile" class="signup" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                        ...
                        <div class="card mb-4 mb-xl-0">
                            ...
                            <div class="card-body text-center box_info">
                                <div class="avatar">
                                    ...
                                    <img id="preview" class="preview-img" style="margin-left: 20%;border-radius: 50%; width: 200px; height: 200px; border: 1px solid black; margin-bottom: 10px"  src="${pageContext.request.contextPath}/resources/uploads/${sessionScope.mentor.ava}">
                                    ...
                                    <br>
                                    <input type="hidden" name="image-initiate" value="${sessionScope.mentor.ava}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body box_info">
                                ...
                                <div class="row">
                                    <div class="col-md-6">  
                                        ...
                                        <input class="form-control" id="inputUsername" readonly name="username" type="text" placeholder="Enter your username" value="${sessionScope.mentor.account.username}">
                                        <p class="username-error" style="color:red"></p>
                                    </div>
                                    <div class="col-md-6">  
                                        <label class="mb-1" for="inputDob">Date of birth</label><br>
                                        <input type="date" id="inputDob" class="form-control acceptEdit" name="dob" readonly value="${sessionScope.mentor.dateOfBirth}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control acceptEdit" readonly name="name" id="inputFirstName" type="text" placeholder="Full Name" value="${sessionScope.mentor.name}">
                                        <p class="name-error" style="color:red"></p>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="mb-1" for="inputEmail">Email</label>
                                        <input class="form-control" readonly  name="email" id="inputEmail" type="text" placeholder="Email" value="${sessionScope.mentor.account.email}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control acceptEdit" name="add"  readonly id="inputAddress" type="text" placeholder="Address" value="${sessionScope.mentor.address}">
