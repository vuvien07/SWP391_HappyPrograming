...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-black" style="padding: 0px; width: 270px; background-color: black">
    <div class="position-sticky">
        <div class="list-group list-group-flush mx-3 mt-4" style="margin: 0">
            ...
            <a href="manager" class="list-group-item list-group-item-action" aria-current="true" style="margin-top: 10px;">
            ...
            <a href="manage_cv" class="list-group-item list-group-item-action" style="margin-top: 10px">
                <span style="font-size: 16px; font-weight: 600">Manage CV</span>
            </a>
            <a href="manageMentor" class="list-group-item list-group-item-action" style="margin-top: 10px">
                <span style="font-size: 16px; font-weight: 600">Manage Mentors</span>
            </a><!--
