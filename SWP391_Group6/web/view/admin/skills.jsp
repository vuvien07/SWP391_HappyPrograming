<%-- 
    ...
    Created on : May 29, 2024, 4:59:58 PM
    Author     : ADMIN
--%>
                            ...
                            <div class="row" style="">
                                ...
                                <div class="col-lg-6" style="text-align: center; margin-top: 20px; margin-bottom: 20px;padding-top: 20px;">
                                    <form action="managersupplier" method="post" style="display: flex; justify-content: center">
                                        <input name="valueSearch" value="${requestScope.searchValue != null ? requestScope.searchValue : ""}" id="searchId" type="text" oninput="searchByName()" placeholder="Search skill name" style="width: 60%; padding: 4px 10px; border-radius: 15px">
