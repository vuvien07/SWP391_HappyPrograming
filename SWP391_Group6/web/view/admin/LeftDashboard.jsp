    ...
    <div class="position-sticky">
        <div class="list-group list-group-flush mx-3 mt-4" style="margin: 0">
            ...
            <a href="skills" class="list-group-item list-group-item-action" style="margin-top: 10px">
                <span style="font-size: 16px; font-weight: 600">Manager Skills</span>
            </a>

            <a href="managercv" class="list-group-item list-group-item-action" style="margin-top: 10px">
                <span style="font-size: 16px; font-weight: 600">Manager CV of Mentor</span>
            </a>
