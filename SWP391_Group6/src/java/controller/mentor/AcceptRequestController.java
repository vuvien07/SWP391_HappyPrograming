...
public class AcceptRequestController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        userNotification.setTitle("Your request has been accepted");
        notificationDBContext.createUserNotification(userNotification);
        requestDBContext.updateStatusRequest(Integer.parseInt(requestId));
        sessionDBContext.updateSession(skill, Integer.parseInt(userid), Integer.parseInt(requestId));
    }
