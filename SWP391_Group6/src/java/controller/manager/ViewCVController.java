 ...
 * @author Admin
 */
public class ViewCVController extends BaseAuthController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response, Account account)
        ...
        CV mentorCV = cvDBContext.getCVByMentor(Integer.parseInt(mentorIdStr));
        request.setAttribute("cv", mentorCV);
        String[] cvSkills = mentorCV.getSkills().split("\n");
        request.setAttribute("cvSkills", cvSkills);
        request.getRequestDispatcher("WEB-INF/view/manager/viewcv.jsp").forward(request, response);
    }
