...
public class ViewCVController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            MentorCV mentorCV = mentorDAO.getMentorCVById(mentorId);

            if (mentorCV == null) {
                response.sendError(HttpServletResponse.SC_NOT_FOUND, "Mentor CV not found");
                return;
            }

            request.setAttribute("mentorCV", mentorCV);
            request.getRequestDispatcher("view/admin/viewCV.jsp").forward(request, response);
